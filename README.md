...
- [langgptai/LangGPT](https://github.com/langgptai/LangGPT) - LangGPT: Empowering everyone to become a prompt expert!🚀  Structured Prompt，Language of GPT, 结构化提示词，结构化Prompt, Created by 「云中江树」 (2 months ago)
- [qodo-ai/qodo-cover](https://github.com/qodo-ai/qodo-cover) - Qodo-Cover: An AI-Powered Tool for Automated Test Generation and Code Coverage Enhancement! 💻🤖🧪🐞 (3 months ago)
- [PostHog/posthog](https://github.com/PostHog/posthog) - 🦔 PostHog provides open-source web &amp; product analytics, session recording, feature flagging and A/B testing that you can self-host. Get started - free. (10 months ago)
...
- [Add Claude Code GitHub Workflow](https://github.com/telepace/nexus/pull/273) on [telepace/nexus](https://github.com/telepace/nexus) (1 day ago)
- [修复: 优化 AI 分析指令加载, 防止重复加载导致性能浪费 (fixes #261)](https://github.com/telepace/nexus/pull/265) on [telepace/nexus](https://github.com/telepace/nexus) (2 weeks ago)
- [✨ Add Intelligent Card-Block Interface Component](https://github.com/telepace/nexus/pull/247) on [telepace/nexus](https://github.com/telepace/nexus) (4 weeks ago)
- [docs: 补充 Content Library 阅读界面命名体系和完整术语定义](https://github.com/telepace/nexus/pull/222) on [telepace/nexus](https://github.com/telepace/nexus) (1 month ago)
- [Fix: Correctly pass --passWithNoTests to Jest](https://github.com/telepace/nexus/pull/203) on [telepace/nexus](https://github.com/telepace/nexus) (1 month ago)
...
- [2024 Annual Review](https://nsddd.top/posts/2024-annual-review/) <small>(5 months ago)</small>
...
- [Metacognitive Transformation Review](https://nsddd.top/posts/metacognitive-transformation-review/) <small>(2 months ago)</small>
- [Mem0](https://nsddd.top/posts/mem0/) <small>(2 months ago)</small>
- [UFO](https://nsddd.top/posts/ufo/) <small>(2 months ago)</small>
- [Argo Cd](https://nsddd.top/posts/argo-cd/) <small>(2 months ago)</small>
...
- [2024 年度回顾](https://nsddd.top/zh/posts/2024-annual-review/) <small>(5 months ago)</small>
- [如何在博客中优雅地展示旅行足迹 - PolarSteps 集成指南](https://nsddd.top/zh/posts/travel-with-polarsteps/) <small>(1 year ago)</small>
- [四个月的一些思考片段整理](https://nsddd.top/zh/posts/metacognitive-transformation-review/) <small>(2 months ago)</small>
- [Mem0 开源项目：AI记忆层的技术分析与实践](https://nsddd.top/zh/posts/mem0/) <small>(2 months ago)</small>
- [微软UFO项目深度解析：设计、实现、原理与架构](https://nsddd.top/zh/posts/ufo/) <small>(2 months ago)</small>
- [Argo CD: Declarative GitOps for Kubernetes Continuous Delivery](https://nsddd.top/zh/posts/argo-cd/) <small>(2 months ago)</small>
...
[![](https://img.shields.io/badge/-Markdown-black?style=flat-square&logo=markdown&logoColor=ffffff)](https://www.markdownguide.org/)
 ...
 🚀 Shanghai time of last status update by the bot <a href='https://github.com/kubbot'>@kubbot</a>: 2025-08-01 16:35:04
